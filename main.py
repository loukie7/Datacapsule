...
sse_service = SSEService(inference_service.inference_processor)

# 初始化各个模块的服务实例
from api.chat import init_services as init_chat_services
from api.training import init_services as init_training_services  

init_chat_services(inference_service, sse_service)
init_training_services(inference_service, sse_service)
